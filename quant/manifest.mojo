...
def quant_manifest[
    ...
    binding bridge derive from this. Mirrors the shapes the loader and quantizer
    historically hand-rolled per variant."""
...
def manifest_arena_bytes[
    ...
    var m = quant_manifest[encoding, shape, quant]()
    var total = 0
